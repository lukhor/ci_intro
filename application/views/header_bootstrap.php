...
<script>$('.carousel').carousel()$('.carousel').carousel()</script>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img src="http://i.haymarket.net.au/Galleries/20121213024803_BMW-M6-Gran-Coupe-1[2]%20(1).jpg" alt="img1">
                <div class="carousel-caption">
                   <p>img1</p>
                </div>
            </div>
            <div class="item">
                <img src="http://stwot.motortrend.com/files/2013/04/BMW-6-Series-Gran-Coupe-Uwe-Duttmann-model-in-front-of-theater-close-crop.jpg" alt="img2">
                <div class="carousel-caption">
                    <p>img2</p>
                </div>
            </div>
            <div class="item">
                <img src="http://i.haymarket.net.au/Galleries/20121213024803_BMW-M6-Gran-Coupe-1[2]%20(1).jpg" alt="img3">
                <div class="carousel-caption">
                    <p>img3</p>
                </div>
            </div>
